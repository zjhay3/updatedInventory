...
if __name__ == '__main__':
    ...
    root.title("MSD Godspeed Inventory Management System")
    width = 1080
    height = 700
    ...
    im = Image.open(resource_path(os.path.join("images", "icon.png")))
    ...
    cost_price_label = Label(entry_frame, text="Unit Cost: ")
